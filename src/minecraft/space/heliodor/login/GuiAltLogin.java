...
public final class GuiAltLogin extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 0: {
                ...
                this.thread = new AltLoginThread(this.username.getText(), this.password.getText(), TheAlteningAuthentication.mojang());
                this.thread.start();
                break;
            }
            case 69: {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(69, width / 2 - 100, var3 + 72 + 12 + 24 + 24, "TheAltening"));
    ...
    public String getUsername() {
        if(password == null) {
            AltLoginThread alt = new AltLoginThread(username.getText(), password.getText(), TheAlteningAuthentication.mojang());

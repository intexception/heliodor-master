...
public class CollisionUtil {
    ...
    public static double directionCheck(final BlockPos sourceFoot, final double eyeHeight, final Vec3 dir, final double targetX, final double targetY, final double targetZ, final double targetWidth, final double targetHeight, final double precision)
    {
        return directionCheck(sourceFoot.getX(), sourceFoot.getY() + eyeHeight, sourceFoot.getZ(), dir.xCoord, dir.yCoord, dir.zCoord, targetX, targetY, targetZ, targetWidth, targetHeight, precision);
    }
}

...
public abstract class Render<T extends Entity>
{
    ...
    public void doFakeRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        this.renderFakeName(entity, x, y, z);
    }
    ...
    protected void renderName(T entity, double x, double y, double z)
    {
        ...
        {
            this.renderLivingLabel(entity, entity.getDisplayName().getFormattedText(), x, y, z, 64, false);
        }
    }

    protected void renderFakeName(T entity, double x, double y, double z)
    {
        if (this.canRenderName(entity))
        {
            this.renderLivingLabel(entity, entity.getDisplayName().getFormattedText(), x, y, z, 64, true);
        }
    }
    ...
    {
        this.renderLivingLabel(entityIn, str, x, y, z, 64, false);
    }
     ...
     */
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance, boolean hide)
    {

...
public class LayerCape implements LayerRenderer
{
    ...
    public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale)
    {
        ...
        {
            if(Heliodor.INSTANCE().moduleMgr.getModuleByName("Cape").isToggled() && entitylivingbaseIn.getName().equalsIgnoreCase(Minecraft.getMinecraft().getSession().getUsername())) {
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                this.playerRenderer.bindTexture(new ResourceLocation("cape.png"));

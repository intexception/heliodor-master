...
public class RenderManager
{
    ...
    public boolean renderEntityWithPosYawWithoutName(Entity entityIn, double x, double y, double z, float entityYaw, float partialTicks)
    {
        return this.doRenderEntityWithoutName(entityIn, x, y, z, entityYaw, partialTicks, false);
    }
    ...
    public boolean doRenderEntityWithoutName(Entity entity, double x, double y, double z, float entityYaw, float partialTicks, boolean p_147939_10_)
    {
        Render render = null;
        ...
        try
        {
            ...
            if (render != null && this.renderEngine != null)
            {
                try
                {
                    ...
                    render.doFakeRender(entity, x, y, z, entityYaw, partialTicks);
                }
                catch (Throwable throwable2)
                {
                    throw new ReportedException(CrashReport.makeCrashReport(throwable2, "Rendering entity in world"));

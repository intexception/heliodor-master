...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 + 4 + 155, this.height - 28, 75, 20, I18n.format("Alt Login", new Object[0])));
        this.buttonList.add(new GuiButton(12, this.width / 2 + 4 + 76, this.height - 28, 75, 20, I18n.format("gui.cancel", new Object[0])));
